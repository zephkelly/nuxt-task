...
describe('TaskQueue', () => {
    ...
    describe('Task Execution', () => {
        it('should handle task execution failure and retry', async () => {
            ...
            expect(retryEmitSpy).toHaveBeenCalledWith('retry', expect.any(Object))
        ...
        it('should respect max retries', async () => {
            ...
            localTask.execute = vi.fn().mockRejectedValue(new Error('test error'))
    ...
    describe('Event Emission', () => {
        it('should emit correct events during task lifecycle', async () => {
            ...
            expect(eventSpy).toHaveBeenCalledWith('started', expect.any(Object))
            expect(eventSpy).toHaveBeenCalledWith('completed', expect.any(Object))
        })
