...
// Create mock storage class that implements the Storage interface
...
// Mock the global window object with our storage implementations
vi.stubGlobal('localStorage', mockLocalStorage);
vi.stubGlobal('sessionStorage', mockSessionStorage);

// Create a valid test job for storage tests
const createTestJob = () => ({
    name: 'Test Job',
...
describe('Storage Factory', () => {
    ...
    describe('Browser Storage Factory', () => {
        ...
        it('should create localStorage with config', async () => {
            ...
            // Verify item was stored in localStorage with correct prefix
        ...
        it('should create sessionStorage with config', async () => {
            ...
            // Verify item was stored in sessionStorage with correct prefix
