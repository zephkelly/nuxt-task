...
describe('Storage Factory', () => {
  ...
  describe('Server Storage Factory', () => {
    ...
    it('should throw error for unsupported storage types', async () => {
                        ...
                        await expect(async () => {
                                ...
                                "Storage type localStorage is not supported in server environment"
                        );
                })
  })
  ...
  describe('Browser Storage Factory', () => {
    ...
    it('should create localStorage with config', async () => {
      ...
      const keys = Array.from(
                        ...
                        const key = keys.find(
                                (k) => k.startsWith('test:') && k.includes(storedTask.id),
      );
  ...
  describe('Edge Cases', () => {
      ...
      const keys = Array.from(
                        ...
                        const key = keys.find(
                                (k) => k.startsWith('cron:') && k.includes(storedTask.id),
      );
                        expect(key).toBeDefined()
