import TimezoneUtils, { type FlexibleTimezoneOptions, type StrictTimezoneOptions } from '../timezone'
...
export class CronExpressionUtils {
    ...
    public validateValue(field: CronField, value: number): boolean {
    ...
    private parseNumericValue(field: CronField, value: string, context: string): number {
    ...
    private handleList(field: CronField, value: string): ParseFieldResult {
    ...
    private handleStep(field: CronField, value: string): ParseFieldResult {
    ...
    private handleRange(field: CronField, value: string): ParseFieldResult {
    ...
    public parseField(field: CronField, value: string): ParseFieldResult {
...
export default new CronExpressionUtils()